...
{//回到顶部
    let toTopBtn = document.querySelector('.sb3Top');
    let sidebottomTop = document.querySelector('.sidebottomTop');
    let sbc=document.querySelectorAll('.sbcontent');
    let sbcp=document.querySelectorAll('.sbcontent p');
    let sbci=document.querySelectorAll('.sbcontent i');
    let sb1=document.querySelector('.sb1Top');
    let sb2=document.querySelector('.sb2Top');
    ...
    window.onscroll = () => {
        ...
        if (scrollDis > 10) {
            ...
            sb1.className = 'sbcontent sb1';
            sb3.className = 'sbcontent sb3';
        }
        else {
            toTopBtn.style.display = 'none';
            sidebottomTop.className = 'sidebottomTop';
            sb1.className = 'sbcontent sb1Top';
            sb2.className = 'sbcontent sb2Top';
            sb3.className = 'sbcontent sb3Top';
        }
    }
    ...
    for (let i = 0; i < 3; i++){
        let j = i;
        sbc[j].addEventListener('mouseover', () => {
            sbcp[j].style.color = 'white';
            sbci[j].style.color = 'white';
        })        
    }

    for (let i = 0; i < 3; i++){
        let j = i;
        sbc[j].addEventListener('mouseout', () => {
            sbcp[j].style.color = 'var(--text1, rgb(133, 133, 133))';
            sbci[j].style.color = 'var(--text1, rgb(133, 133, 133))';
        })        
    }
